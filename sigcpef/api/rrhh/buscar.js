// ARCHIVO: api/rrhh/buscar.js
/**
 * @descripcion: Busqueda rapida de funcionarios.
 * @endpoint: GET /api/rrhh/buscar?q=texto
 * @autenticacion: Requiere token JWT rol 'RRHH' o 'ADMIN'.
...
export default async function handler(req, res) {
  ...
  const filter = q
    ...
    : {};
  const data = await Funcionario.find(filter).limit(20).lean();
